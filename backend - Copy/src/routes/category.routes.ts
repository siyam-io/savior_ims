...
router.route("/sub/:id")
  .delete(authorize(PERMISSIONS.DELETE_CATEGORY), CatCtrl.deleteSubCategory);
...
router.route("/:id")
  ...
  .put(authorize(PERMISSIONS.EDIT_CATEGORY), CatCtrl.updateCategory)
  .delete(authorize(PERMISSIONS.DELETE_CATEGORY), CatCtrl.deleteCategory);
